...
def get_market_data():
    ...
    for name, sym in TICKERS.items():
        try:
            ...
            # Kombinierte Anzeige
            # =========================
            interp = f"{interp_chg}" if interp_rvol=="N/A" else f"{interp_chg} / {interp_rvol}"
...
<title>Gschmäckle Radar v2.2</title>
...
<h2 class="text-center neon mb-2">Gschmäckle Radar v2.2 🚀</h2>
